...
custoKmPercorrido, valorPedagio = map(int, input().split())
 
quantidadePedagios = comprimentoEstrada // distanciaPedagios
gastoGasolina = comprimentoEstrada * custoKmPercorrido
gastoPedagios = quantidadePedagios * valorPedagio
total = gastoGasolina + gastoPedagios
